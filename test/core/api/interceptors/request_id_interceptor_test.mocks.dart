...
// in flutter_app/test/core/api/interceptors/request_id_interceptor_test.dart.
...
/// A class which mocks [NetworkLogService].
///
/// See the documentation for Mockito's code generation for more information.
class MockNetworkLogService extends _i1.Mock implements _i3.NetworkLogService {
  MockNetworkLogService() {
    _i1.throwOnMissingStub(this);
  }

  @override
  List<_i3.NetworkLogEntry> get logs => (super.noSuchMethod(
        Invocation.getter(#logs),
        returnValue: <_i3.NetworkLogEntry>[],
      ) as List<_i3.NetworkLogEntry>);

  @override
  void addLog(_i3.NetworkLogEntry? entry) => super.noSuchMethod(
        Invocation.method(
          #addLog,
          [entry],
        ),
...
class MockRequestInterceptorHandler extends _i1.Mock
  ...
  @override
  void next(_i7.RequestOptions? requestOptions) => super.noSuchMethod(
        Invocation.method(
          #next,
          [requestOptions],
        ),
