...
class VerseDetailPage extends ConsumerWidget {
  const VerseDetailPage({required this.verseId, super.key});

  final String verseId;

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final verse = VersesMockDataExtension.getVerseById(verseId);
              ...
              children: [
                ...
                Expanded(
                  child: SingleChildScrollView(
                    ...
                    child: _buildVerseContent(context, ref, verse, isSaved, colorScheme),
                  ),
                ),
              ],
            ),
          ...
          children: [
            Expanded(
              child: _buildActionButton(
                ...
                isActive: isSaved,
                onTap: () {
                  ref.read(savedVersesProvider.notifier).toggleSaveVerse(verse.id);
